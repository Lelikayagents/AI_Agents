...
- **British vs American spelling mixed in the same document.** _(flag, 2026-08-18)_: «authorised» person/representative/bodies (BrE spelling, notices clause and again in the confidentiality clause's 1.8) coexists with «recognized» courier service/organization (AmE, notices clause) and «organizations» (AmE, confidentiality clause 1.3(e)), plus a third wobble on «electronic mail» / «email» / «E-mail». Not a translation-accuracy issue, but worth a consistency pass — pick one convention (BrE or AmE) before final delivery. Do not silently pick one; ask which the user's house style prefers.

...
| абзац | paragraph | RU→EN | Via multitran (legal category), 2026-08-19. Multitran's legal entries specifically offer "sub-paragraph"/"unnumbered paragraph" for narrower cases — use "paragraph" as the default, "sub-paragraph" only when distinguishing an unnumbered indent within a numbered Пункт | 2026-08-19 | word-list lookup, chat |
